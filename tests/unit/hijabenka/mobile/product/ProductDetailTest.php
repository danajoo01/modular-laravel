...
class ProductDetailTestHBM extends TestCase
{
	/** @test */
	function product_detail_show_ok_hbm()
	{
	...
	/** @test */
	function product_detail_show_failed_cause_category_empty_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function product_detail_show_failed_cause_parent_id_productname_empty_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/* RESULT -> if parent or id or productname empty or null will redirect to catalog */
	/** @test */
	function set_wishlist_check_proccess_ok_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function set_wishlist_check_proccess_not_login_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
