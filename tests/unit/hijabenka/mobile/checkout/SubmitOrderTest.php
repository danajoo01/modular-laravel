...
class SubmitOrderTestHBM extends TestCase
{
	...
	/** @test */
	function submit_order_access_redirect_when_not_login_hbm()
	{
	...
	/** @test */
	function submit_order_access_redirect_when_login_but_dont_have_cart_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function submit_order_access_ok_when_login_and_have_cart_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
		...
		$this->assertEquals(200, $response->getStatusCode());
		$this->assertResponseOk();
		$this->see('DAFTAR BELANJA ANDA');
	}

	/** @test */
	function check_submit_order_if_customer_dont_have_address_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_submit_order_customer_have_address_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_shipping_province_and_area_match_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_add_address_empty_field_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_add_address_wrong_condition_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_add_address_ok_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_edit_address_empty_field_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_edit_address_with_data_another_user_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_edit_address_wrong_condition_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_edit_address_ok_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_set_primary_ok_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_set_primary_with_data_another_user_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_value_shipping_ok_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_method_payment_enabled_submit_order_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_freeshipping_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_not_freeshipping_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_payment_code_for_transfer_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_payment_code_exclude_transfer_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_next_delivery_by_payment_method_exclude_transfer_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_same_next_delivery_by_payment_method_transfer_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_not_freeshipping_when_shipping_method_same_next_delivery_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_same_next_delivery_by_set_primary_address_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_next_delivery_by_payment_method_exclude_transfer_before_11_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
	...
	/** @test */
	function check_get_freegift_auto_hbm()
	{
		$domain = env('HIJABENKA_MOBILE', 'm-herman.hijabenka.biz');
		...
		$this->assertNotNull($response->getOriginalContent()->getData()['freegift_auto']);
		$this->assertEquals(200, $response->getStatusCode());
		$this->assertResponseOk();
	}
}
