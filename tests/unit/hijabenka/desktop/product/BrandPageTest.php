...
class BrandPageHBTest extends TestCase
{
	...
	/** @test */
	function check_all_array_not_null_from_brand_hb_page()
	{	
		...
		foreach ($brands as $value) {
			...
			if(count($products) > 0){
				...
				if($name != 'converse' && $name != 'zavica' && $name != 'wardah'){
	...
	/** @test */
	function check_brand_page_filter_category_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_price_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_size_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_price_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_size_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color_price_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color_size_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_price_size_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color_price_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color_size_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color_price_size_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color_price_size_hb()
	{
		$domain = env('HIJABENKA', 'herman.hijabenka.biz');
