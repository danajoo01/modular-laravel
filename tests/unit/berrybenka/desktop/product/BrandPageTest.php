...
class BrandPageTest extends TestCase
{
	...
	{
		$data['title'] = $response->getOriginalContent()->getData()['title'];
	...
	/** @test */
	function check_all_array_not_null_from_brand_page()
	{	
	...
	/** @test */
	function check_brand_page_filter_category()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_price()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_size()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_price()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_size()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color_price()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color_size()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_price_size()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color_price()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color_size()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_color_price_size()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
	...
	/** @test */
	function check_brand_page_filter_category_color_price_size()
	{
		$domain = env('BERRYBENKA', 'herman.berrybenka.biz');
