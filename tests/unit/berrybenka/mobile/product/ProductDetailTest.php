...
class ProductDetailTestBBM extends TestCase
{
	/** @test */
	function product_detail_show_ok_bbm()
	{
	...
	/** @test */
	function product_detail_show_failed_cause_category_empty_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function product_detail_show_failed_cause_parent_id_productname_empty_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/* RESULT -> if parent or id or productname empty or null will redirect to catalog */
	/** @test */
	function set_wishlist_check_proccess_ok_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function set_wishlist_check_proccess_not_login_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
