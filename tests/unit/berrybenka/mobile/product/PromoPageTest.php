...
class PromoPageTestBBM extends TestCase
{
	...
	/** @test */
	function check_all_array_not_null_from_promo_page_bbm()
	{
	...
	/** @test */
	function check_promo_page_param_gender_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_color_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
		...
		foreach ($promos as $value) {
			...
			foreach($get_data['size'] as $size_all){
				if(isset($size_all->product_size_url) && $size_all->product_size_url != ''){
					$size = $size_all->product_size_url;
				}else{
					$size = str_replace(' ','_',strtolower($size_all->product_size));
				} 
				
				if($size != ''){
					$response2 = $this->call('GET','http://'.$domain.'/'.$url.'?size='.$size);
	...
	/** @test */
	function check_promo_page_param_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_color_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_color_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_color_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_color_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_color_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_price_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_price_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_color_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_color_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_color_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_color_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_price_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_price_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_color_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_color_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_color_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_price_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_price_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_color_price_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_color_price_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_price_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_color_price_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_color_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_color_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_color_price_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_color_price_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_price_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_color_price_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_color_price_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_color_price_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_color_price_size_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_color_price_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_color_price_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_category_color_price_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
	...
	/** @test */
	function check_promo_page_param_gender_category_color_price_size_brand_bbm()
	{
		$domain = env('BERRYBENKA_MOBILE', 'm-herman.berrybenka.biz');
