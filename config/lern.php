...
return [
    ...
    'notify'=>[
         ...
         */
        'log_level' => 'emergency', //Options are: debug, info, notice, warning, error, critical, alert, emergency.
         ...
         */
        'slack'=>[
            'token'   => env('SLACK_APP_TOKEN', 'xoxp-21938194464-72350129091-72405663413-fc1902fea4'), //https://api.slack.com/web#auth
            'channel' => env('SLACK_CHANNEL', '#onsite'), //Dont forget the '#'
            'username'=> env('SLACK_USERNAME', 'BenkaError'), //The 'from' name
        ],
