...
<link rel="stylesheet" href="{{ asset('berrybenka/desktop/css/product-detail.css') }}">
<style>
	.error-content{width:100%;background:url(<?php echo asset('berrybenka/desktop/img/errorbg.gif'); ?>) center repeat;}
            ...
            <ul class="need-help">
                ...
                */?>
                <li>
                    ...
                    </span> Email Kami <br> <strong><a href="mailto:bjs@onedeca.com">bjs@onedeca.com</a></strong>
                </li>
                <li>
