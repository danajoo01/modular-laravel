                                    ...
                                    <?php 
                                        ...
                                        <p>
                                            ...
                                            <?php }else{?>                                                                                                
                                                ...
                                                ?>
                                                METODE PEMBAYARAN : {{ $payment_method }} <br /> STATUS : {{ $pay_stat }} <br /><br />
                                                Kamu belum menyelesaikan pembayaran. Klik tombol "LANJUT KE T-CASH" di bawah ini untuk melanjutkan pembayaran<br />
                                                <?php /* <form method="POST" action="{{ $data['tcash_detail']['tcash_webcheckout'] }}">
                                                ...
                                                <a href="{{ $data['tcash_detail']['tcash_redirect'] }}" class="confirm-button" style="background:#ED1B24;color:#fff;">LANJUT KE T-CASH</a>
                                                <br>
                                                <br>
