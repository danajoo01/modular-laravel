                                    ...
                                    <?php 
                                        ...
                                        <p>
                                            ...
                                            <?php }else{?>
                                                ...
                                                ?>
                                                METODE PEMBAYARAN : T-Cash <br /> STATUS : {{ $pay_stat }} <br /><br />
                                                Kamu belum menyelesaikan pembayaran. Klik tombol "LANJUT KE T-CASH" di bawah ini untuk melanjutkan pembayaran<br />
                                                <?php /*
                                                <form method="POST" action="{{ $data['tcash_detail']['tcash_webcheckout'] }}">
                                                <input type="text" name="message" value="{{ $data['tcash_detail']['tcash_signature'] }}" hidden>
                                                <input type="submit" value="LANJUT KE T-CASH" style='background: #ED1B24;color: #fff;padding: 8px 15px;letter-spacing: 2px;text-transform: uppercase;border-radius: 5px;cursor: pointer;font: 16px "futura", sans-serif;'>
                                                </form> */ ?>
                                                <br>
                                                <a href="{{ $data['tcash_detail']['tcash_redirect'] }}" class="confirm-button" style='background:#ED1B24;color:#fff;padding: 8px 15px;letter-spacing: 2px;text-transform: uppercase;border-radius: 5px;cursor: pointer;font: 16px "futura", sans-serif;display: inline-block;'>LANJUT KE T-CASH</a>
                                                <br>
                                                <br>
                                                <p>Jika sudah melakukan pembayaran tapi status masih "BELUM TERBAYARKAN", silakan lakukan konfirmasi manual. </p>
                                                ...
                                                ?>
                                                METODE PEMBAYARAN : Go-Pay <br /> STATUS : {{ $pay_stat }} <br /><br />
                                                Kamu belum menyelesaikan pembayaran. Klik tombol "BAYAR DENGAN GO-PAY" di bawah ini untuk melanjutkan pembayaran<br />
                                                <a href="{{ $data['gopay_url'] }}" class="confirm-button" target="_blank" style="background:#295DB3;color:#fff;width: 190px;">BAYAR DENGAN GO-PAY</a>
                                                <?php } else if ($data["invoice_detail"]->master_payment_id == 343 && $data["invoice_detail"]->status == '0') {
                                                ?>
                                                METODE PEMBAYARAN : Non-Transfer [GO-PAY] <br /> STATUS : {{ $pay_stat }} <br /><br />
                                                Kamu belum menyelesaikan pembayaran. Klik tombol "BAYAR DENGAN GO-PAY" di bawah ini untuk melanjutkan pembayaran<br />
                                                <a href="{{ $data['gopay_url'] }}" class="confirm-button" target="_blank" style="background:#295DB3;color:#fff;width: 190px;">BAYAR DENGAN GO-PAY</a>
                                                <?php } else { ?>
                                                METODE PEMBAYARAN : Non-Transfer <br /> STATUS : {{ $pay_stat }} 
                                                <?php } ?> 
                                            <?php }?>
                                        </p>
                                    <?php 
