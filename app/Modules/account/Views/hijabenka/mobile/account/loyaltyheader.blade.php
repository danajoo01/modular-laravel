<div class="loyalty-header">
    ...
    <p><br /><a href="#">Benka Point Anda : IDR {{ number_format($user->customer_credit,0,".",".") }}</a></p>
    <div class="loyalty-type">
        <ul>
            <li>
                <img src="/hijabenka/mobile/img/bb-stamp/bb-stamp-large.png" alt="">
                <p>Kamu Memiliki {{ isset($user->stamp_active) ? $user->stamp_active : 0}} Active Benka Stamp</p>
            </li>
            <li>
                <img src="/hijabenka/mobile/img/bb-stamp/pending-stamp.png" alt="">
