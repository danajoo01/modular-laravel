        ...
        <div class="account-body">
            <div class="benka-wrapper">
                <ul>
                    <li>
                        <h1 class="border-bot b-gratis">
                            <a href="#">belanja gratis shopdeca</a>
                ...
                <div class="b-gratis-bb">
                    <p>Ajak teman mendownload Aplikasi Shopdeca dan dapatkan Benka Poin senilai IDR 25,000!
                        <br>
...
branch.init('key_live_hepq2pnNWbgVpCwl6uHGidjesvat5Vkd');
    ...
    data: {
        ...
        var url_whatsapp = "whatsapp://send?text=Download aplikasi Shopdeca dan dapatkan Benka Poin untuk berbelanja senilai IDR 25.000 tanpa minimum pembelian. "+ link +"";
    ...
    data: {
        ...
        var url_line = "http://line.me/R/msg/text/?Download aplikasi Shopdeca dan dapatkan Benka Poin untuk berbelanja senilai IDR 25.000 tanpa minimum pembelian. "+ link +"";
