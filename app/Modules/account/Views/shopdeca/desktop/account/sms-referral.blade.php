...
<link rel="stylesheet" href="https://m.shopdeca.com/assets/shopdeca/mobile/css/bb-mobile.min.css?v=1.2"/>
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('shopdeca/desktop/img/favicon.png') }}" />
<style>
html, body{margin:0;padding:0;background:url({{ asset('shopdeca/desktop/img/bg.jpg') }} ) center center no-repeat;background-size:cover;width:100%;height:100%;}
img{max-width:100%;}
