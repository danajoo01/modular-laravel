                ...
                <div class="user-dashboard clearfix">
                    ...
                    <div class="referral-code">
                        ...
                        <div class="referral-body">
                            <p>Ajak teman mendownload Aplikasi Shopdeca dan dapatkan <br>Benka Poin senilai IDR 25,000!</p>
                            <div class="code-ref">
                            ...
                            <div class="nobl half-ref-code-content referral-code mt0">
                                ...
                                <div class="termcon">
                                    <ul>
                                        ...
                                        <li>Benka Poin senilai IDR 25,000 akan ditambahkan kepada teman yang anda undang setelah men-download aplikasi Shopdeca dan register akun baru</li>
                                        ...
                                        <li>Shopdeca berhak menolak segala transaksi apabila ditemukan indikasi   kecurangan yang dilakukan oleh pengguna dalam referral program</li>
                                        <!--<li>Info lebih lanjut klik <a href="http://shopdeca.com/special-promo/referral-program">disini</a></li>-->
                                    </ul>
                                </div>
                            </div>
                        </div>
...
branch.init('key_live_hepq2pnNWbgVpCwl6uHGidjesvat5Vkd');
    ...
    data: {
		...
		var url_fb = "javascript:fbShare('"+ link + "','Fb Share','Facebook share popup','{{ asset('shopdeca/desktop/img/sosmed/fb.jpg') }}',520,350)";
    ...
    data: {
		...
		var url_tw = "http://twitter.com/intent/tweet?url="+ link +"&text=Download aplikasi Shopdeca dan dapatkan Benka Poin untuk berbelanja senilai IDR 25.000.";
    ...
    data: {
		...
		var url_email = "mailto:?subject=Belanja Gratis Di Shopdeca&body=Download aplikasi Shopdeca dan dapatkan Benka Poin untuk berbelanja senilai IDR 25.000 tanpa minimum pembelian. " + link +"";
