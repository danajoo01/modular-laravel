...
class VoucherCondition extends Model {
	 ...
	 * @var string
	 */
	protected $table = 'voucher_condition'; //Define your table name

	protected $primaryKey = 'voucher_condition_id'; //Define your primarykey
	 ...
	 * @var array
	 */
	protected $guarded = ['voucher_condition_id']; //Define your guarded columns
