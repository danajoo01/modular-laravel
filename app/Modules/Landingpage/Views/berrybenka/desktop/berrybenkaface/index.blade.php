...
@section('css')
<!-- CSS here -->
<link rel="stylesheet" href="{{ asset('berrybenka/desktop/css/bbface.css') }}">
@endsection
...
<div id="loading">
	<div class="load-icon"><img src="/berrybenka/desktop/img/bb-loading.gif"></div>
</div>
...
$(document).ready(function(){
    $('.success-msg .fa-times').click(function(){
