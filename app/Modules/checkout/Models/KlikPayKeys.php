...
class KlikPayKeys {
	...
	public static function signature($klikPayCode, $transactionNo, $currency = "IDR", $clearKey, $transactionDate, $totalAmount) {
		Self::$trace = array(
		...
		$keyId = strlen($clearKey)==32?$clearKey:Self::keyid($clearKey);
		Self::$trace["keyId"] = $keyId;
		$str1 = $klikPayCode.$transactionNo.$currency.$keyId;
		$str2 = intval(str_replace("/","",substr($transactionDate,0,10))) + intval($totalAmount);
		Self::$trace["firstval"] = $str1;
		Self::$trace["secondval"] = $str2;
		$str1 = Self::dohash($str1);
		$str2 = Self::dohash($str2);
		$str3 = str_replace("-","",bcadd($str1,$str2));
		Self::$trace["thirdval"] = $str3;
		return $str3;
	}
	public static function authkey($klikPayCode,$transactionNo,$currency="IDR",$transactionDate,$clearKey) {
	...
	public static function keyid($clearKey) {
	...
	public static function concat($klikPayCode,$transactionNo,$currency="IDR",$transactionDate,$keyId) {
	...
	public static function tripledes($str,$key) {
