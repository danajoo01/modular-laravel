...
<link rel="stylesheet" href="{{ asset('shopdeca/mobile/css/lebaran-notice.css') }}">
<style>
  .sub-btn{
...
<div id="loading_gif" class="loading-icon" style="z-index: 800">
  <div class="load-icon"><img src="{{ asset('shopdeca/mobile/img/loading.gif') }}"></div>
</div>
        ...
        @foreach($get_customer_address as $customer_address)
          @if($customer_address->address_type == 1 && $alamat_pengiriman == false)
            ...
            <div class="alamat-pengiriman">
              ...
              <a class="edit-address edit-shipping-address" href="#list-alamat"><i class="fa fa-pencil" aria-hidden="true"></i>Ubah Alamat</a>
            </div>
          ...
          @elseif($customer_address->address_type == 2 && $alamat_penagihan == false)
            ...
            <div class="alamat-pengiriman">
              ...
              <p>{{$customer_address->address_city}} - {{$customer_address->address_province}}</p>
              <p>Nomor Handphone: {{$customer_address->address_phone}}</p>
              <a class="edit-address edit-billing-address" href="#list-alamat"><i class="fa fa-pencil" aria-hidden="true"></i>Ubah Alamat</a>
            </div>
    ...
    <div class="payment-method" {!! (empty($get_customer_address)) ? "style='display:none;'" : '' !!}>
      ...
      <ul>
        @foreach($list_payment_method as $payment_method)
          ...
          <li>
            <label class="clear">
              <input class="rad-payment-method" name="rad-payment-method" type="radio" id="RadioGroup2_0" value="{{ $payment_method->master_payment_id }}" {{(session('payment_method') == $payment_method->master_payment_id) ? "checked" : "" }} name="RadioGroup2">
              <span class="clear"><p>{{ $payment_method->master_payment_name }}</p></span>
              <div class="payment-detail">
                <p><i class="fa fa-bell"></i> <strong>CATATAN PENTING:</strong></p>
                @if($payment_method->minimum_grand_total > 0)
                  <ul>
                    <li>Minimum Pembelian Rp. {{ number_format($payment_method->minimum_grand_total) }}</li>
                  </ul>
                @endif
                @if($payment_method->maximum_grand_total > 0)
                  <ul>
                    <li>Maksimum Pembelian Rp. {{ number_format($payment_method->maximum_grand_total) }}</li>
                  </ul>
                @endif
                Harap melakukan transfer maksimal 2x24 jam, jika tidak maka transaksi akan dibatalkan.<br>
                <hr>
          ...
          <li>
            <label class="clear">
              <input class="rad-payment-method" name="rad-payment-method" type="radio" id="RadioGroup2_2" value="{{ $payment_method->master_payment_id }}" {{(session('payment_method') == $payment_method->master_payment_id) ? "checked" : "" }} name="RadioGroup2">
              <span class="clear"><p>{{ $payment_method->master_payment_name }}</p></span>
              <div class="payment-detail">
          ...
          <li>
            <label class="clear">
              ...
              <div class="payment-detail">
                ...
                @endif
                <label>Bayar menggunakan KlikBCA Internet Banking yang disediakan oleh Bank BCA</label>
                <input id="txt-klikbca-user-id" name="klikbcauserid" maxlength="12" type="text" required>
                <div class="clear"></div>
              </div>
            </label>
          </li>
          ...
          <li>
            <label class="clear">
              ...
              <div class="payment-detail">
                <i class="fa fa-bell"></i>
                <strong>CATATAN PENTING:</strong><br>
                <label>Bayar menggunakan Virtual Account Bank Lain</label>
              </div>
            </label>
          </li>
          ...
          <li>
            <label class="clear">
              ...
              <div class="payment-detail">
                ...
                @endif
                <label>Bayar menggunakan BCA KlikPay yang disediakan oleh Bank BCA</label>
              </div>
            </label>
          </li>
          ...
          @elseif($payment_method->master_payment_id == 19 && $is_cod_available)
          <!--COD-->
          <li>
            <label class="clear">
              <input class="rad-payment-method" name="rad-payment-method" type="radio" id="RadioGroup2_2" value="{{ $payment_method->master_payment_id }}" {{(session('payment_method') == $payment_method->master_payment_id) ? "checked" : "" }} name="RadioGroup2">
              ...
              <div class="payment-detail">
                ...
                @endif
                <label>Bayar di Tempat adalah metode transaksi dimana pembayaran dilakukan pada saat barang diterima.</label>
              </div>
            </label>
          </li>
          ...
          <li>
            <label class="clear">
              ...
              <div class="payment-detail">
                ...
                @endif
                <label>Harap melakukan pembayaran maksimal 2x24 jam di Indomaret terdekat, jika tidak maka transaksi akan dibatalkan.</label>
              </div>
            </label>
          </li>
          @elseif($payment_method->master_payment_id == 99)
            ...
            <li>
                <label>
                  <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $payment_method->master_payment_id }}" {{(session('payment_method') == $payment_method->master_payment_id) ? "checked" : "" }} id="RadioGroup2_0" >    
                  <span class="clear"><p>{{ $payment_method->master_payment_name }}</p></span>
                  <div class="payment-detail">
                    <i class="fa fa-bell"></i>
          ...
          <!--Popup Store-->
            @if(!empty($is_popup_store_available))
              @foreach($is_popup_store_available as $key => $popup_store)
                <li id="popup-store-{{ $payment_method->master_payment_id }}" {!!($payment_method->master_payment_id == $is_popup_store_available[$key]->master_payment_id) ? '' : 'style="display: none;"' !!}>
                  <label class="clear">
                    <input class="rad-payment-method" name="rad-payment-method" type="radio" id="RadioGroup2_2" value="{{ $payment_method->master_payment_id }}" {{(session('payment_method') == $payment_method->master_payment_id) ? "checked" : "" }} name="RadioGroup2">
                    <span class="clear"><p>{{ $payment_method->master_payment_name }}</p></span>
                    <div class="payment-detail">
                      ...
                      @endif
                      <label>{{ $payment_method->master_payment_description }}</label>
                    </div>
                  </label>
                </li>
              @endforeach
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.shopdeca.mobile.submit-order')
@endif
