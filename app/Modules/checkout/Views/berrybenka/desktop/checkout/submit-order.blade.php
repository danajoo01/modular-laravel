...
<!--   <div id="loading_gif" style="z-index: 800">
    <div class="load-icon">
      <img src="{{ asset('berrybenka/desktop/img/loading.gif') }}">
    </div>
  </div> -->
  <!-- ******** -->
  ...
  <div class="checkout-cart-list-wrapper">
    @if($err_msg !== NULL)
      <span class="error-msg-login" style="width: 1180px; margin: 10px auto;">
        <i aria-hidden="true" class="fa fa-bell"></i>
        <i aria-hidden="true" class="fa fa-times"></i>
        <span>{!! $err_msg !!}</span>
      </span>
    @endif
    <span id="msg-container" class="error-msg-login" style="display:none; width: 1180px; margin: 10px auto;">
      <i aria-hidden="true" class="fa fa-bell"></i>
      <i aria-hidden="true" class="fa fa-times"></i>
            ...
            @endif            
                @foreach($list_payment_method_virtual_account as $virtual_account)
                  ...
                  <li>
                    <label>
                      ...
                      <span><img style="height:20px" src="{{ asset('berrybenka/desktop/img/bca-va.png') }}">{{ $virtual_account->master_payment_name }} <i class="alert">New</i></span>
                ...
                @elseif($virtual_account->master_payment_id == 98)
                  ...
                  <li>
                    <label>
                      <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $virtual_account->master_payment_id }}" id="RadioGroup2_0"  >
                      <span><img style="height:20px" src="{{ asset('berrybenka/desktop/img/permata_va.jpg') }}">{{ $virtual_account->master_payment_name }} <i class="alert">New</i></span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                        
                        <ul>
              ...
              @foreach($list_payment_method_bank_transfer as $bank_transfer)
                @if($bank_transfer->master_payment_id == 1 || $bank_transfer->master_payment_id == 2 || $bank_transfer->master_payment_id == 29 || $bank_transfer->master_payment_id == 30)
                  ...
                  <li>
                    <label>
                      ...
                      <span><img src="{{ asset('berrybenka/desktop/img/'.$bank_transfer->master_payment_image) }}">{{ $bank_transfer->master_payment_name }}</span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                        
                        <ul>
                ...
                @foreach($list_payment_method_kartu_kredit as $kartu_kredit)
                  @if($kartu_kredit->master_payment_id == 5)
                  <!--Visa/MasterCard-->
                  <li>
                    <label>
                      <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $kartu_kredit->master_payment_id }}" id="RadioGroup2_0"  >
                      <span><img src="{{ asset('berrybenka/desktop/img/'.$kartu_kredit->master_payment_image) }}">{{ $kartu_kredit->master_payment_name }}</span>
                      <div class="payment-info">                        
                          <i class="fa fa-bell"></i>
                          <strong>PANDUAN PEMBAYARAN:</strong><br>
                  ...
                  @elseif($kartu_kredit->master_payment_id == 20)
                  <!--Mandiri Debit-->
                  <li>
                    <label>
                      <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $kartu_kredit->master_payment_id }}" id="RadioGroup2_2">
                      <span><img src="{{ asset('berrybenka/desktop/img/bank-mandiri-logo.jpg') }}">{{ $kartu_kredit->master_payment_name }}</span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                       
                        <ul>
                        ...
                        <div class="clear"></div>
                        <!--<div class="logo-mandiri-debit"><img src="{{ asset('berrybenka/desktop/img/bank-mandiri-logo.jpg') }}"></div>-->
                      </div>
                    </label>
                  </li>        
                  @endif
                ...
                @foreach($list_payment_method_internet_banking as $internet_banking)
                  ...
                  <li>
                    <label>
                      ...
                      <span><img src="{{ asset('berrybenka/desktop/img/'.$internet_banking->master_payment_image) }}">{{ $internet_banking->master_payment_name }}</span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                        
                        <ul>
                ...
                @elseif($internet_banking->master_payment_id == 4)
                  ...
                  <li>
                    <label>
                      <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $internet_banking->master_payment_id }}" id="RadioGroup2_0"  >
                      <span><img style="height:20px" src="{{ asset('berrybenka/desktop/img/'.$internet_banking->master_payment_image) }}">{{ $internet_banking->master_payment_name }}</span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                        
                        <ul>
                  ...
                  <li id="cod-container" style="display:none;">
                    <label>
                      ...
                      <div class="payment-info">
                          <i class="fa fa-bell"></i>
                          <strong>PANDUAN PEMBAYARAN:</strong><br>
                        <!-- @if($cod->minimum_grand_total > 0 || $cod->maximum_grand_total > 0) -->
                          <!-- <i class="fa fa-bell"></i>
                          <strong>PANDUAN PEMBAYARAN:</strong><br> -->                          
                        <!-- @endif -->
                          <ul>
              ...
              @endforeach                
                ...
                @elseif($others->master_payment_id == 24)
                  ...
                  <li>
                    <label>
                      <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $others->master_payment_id }}" id="RadioGroup2_0"  >
                      <span><img src="{{ asset('berrybenka/desktop/img/indomaret.jpg') }}">{{ $others->master_payment_name }} </span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                       
                        <ul>
                ...
                @elseif($others->master_payment_id == 343)
                  ...
                  <li>
                    <label>
                      <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $others->master_payment_id }}" id="RadioGroup2_0"  >
                      <span><img style="height:20px" src="{{ asset('berrybenka/desktop/img/go-pay.png') }}">{{ $others->master_payment_name }} <i class="alert">New</i></span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                       
                        <ul>
...
<script src="{{ asset('js/desktop/submit-order_bb.js?t=').date('YmdHis') }}"></script>
@endsection
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.berrybenka.desktop.submit-order-page')
@endif
