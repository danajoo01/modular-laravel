...
@section('marketing-tag-header')
    @if(getMarketingEnv() == true)
        @include('marketing-tag.berrybenka.desktop.header-thankyou-page', ['marketing_data' => $marketing_data, 'carts' => $fetch_cart, 'total_data' => $total_data])
    @endif
@endsection

@section('marketing-tag-body')
    @if(getMarketingEnv() == true)
        @include('marketing-tag.berrybenka.desktop.body-thankyou-page', ['marketing_data' => $marketing_data, 'carts' => $fetch_cart, 'total_data' => $total_data])
    @endif
@endsection
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.berrybenka.desktop.thankyou-page', ['tag_products' => $tag_products, 'total_data' => $total_data, 'carts' => $fetch_cart]);
@endif
