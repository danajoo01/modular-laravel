...
@section('content')
<div class="error-content thx-wrapper" style="margin-top:70px;">
      @if($status == 0)
      ...
      <div class="card-container">
         ...
         <div class="main">
            <div class="main-content">
               <div class="text-center"><img src="{{$qr_url}}"></div>
            </div>
         </div>
            ...
            <table class="table">
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="table-row text-body text-initial"><span>Setelah pembayaran selesai, untuk dapat mengetahui informasi mengenai pesanan anda, silahkan menggunakan tautan dibawah ini. <br><br><a style="text-align: center;width: 100%;background:#333;color:#fff;padding:8px 15px;margin:20px auto;display:block;" href="<?php echo url('/') . "/user/order_history_detail/" . $po_number; ?>">Informasi Pesanan</a></span></td>
                  </tr>
               </tbody>
            </table>
         </div>
