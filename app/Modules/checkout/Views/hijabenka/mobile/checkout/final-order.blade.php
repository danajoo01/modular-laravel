...
@section('marketing-tag-header')
    @if(getMarketingEnv() == true)
        @include('marketing-tag.hijabenka.mobile.header-thankyou-page', ['marketing_data' => $marketing_data, 'carts' => $fetch_cart, 'total_data' => $total_data]);
    @endif
@endsection

@section('marketing-tag-body')
    @if(getMarketingEnv() == true)
        @include('marketing-tag.hijabenka.mobile.body-thankyou-page', ['marketing_data' => $marketing_data, 'carts' => $fetch_cart, 'total_data' => $total_data]);
    @endif
@endsection
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.hijabenka.mobile.thankyou-page', ['marketing_data' => $marketing_data, 'carts' => $fetch_cart, 'total_data' => $total_data]);
@endif
