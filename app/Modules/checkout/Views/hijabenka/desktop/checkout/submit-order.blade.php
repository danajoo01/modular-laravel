                ...
                @foreach($list_payment_method_others as $others)
                  @if($others->master_payment_id == 99)
                    ...
                    <label>
                      ...
                      <span><img style="height:20px" src="{{ asset('hijabenka/desktop/img/kredivo.png') }}">{{ $others->master_payment_name }} <i class="alert">New</i></span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                  ...
                  <li>
                    <label>
                      <input type="radio" class="rad-payment-method" name="rad-payment-method" value="{{ $others->master_payment_id }}" id="RadioGroup2_0"  >
                      <span><img style="height:20px" src="{{ asset('hijabenka/desktop/img/t-cash.png') }}">{{ $others->master_payment_name }} <i class="alert">New</i></span>
                      <div class="payment-info">
                        <i class="fa fa-bell"></i>
                        <strong>PANDUAN PEMBAYARAN:</strong><br>                       
                        <ul>
