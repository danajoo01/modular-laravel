...
@section('css')
<!-- CSS here -->
<link rel="stylesheet" href="{{ asset('berrybenka/desktop/css/home.css') }}">
<link rel="stylesheet" href="{{ asset('berrybenka/mobile/css/special.css') }}">
@endsection
...
<div class="content">
	<div id="loading">
		<div class="load-icon"><img src="{{ asset('berrybenka/desktop/img/bb-loading.gif') }}"></div>
	</div>
	<div class="special-wrapper">
	    ...
	    <?php $i = 1; ?>
	    @foreach($category as $data)
		    <div class="tab-content" id="{{ $data->category_url }}" @if($i != 1) style=display:none; @endif>
		        <ul>
