...
<h1><i class="fa fa-search" aria-hidden="true"></i>Filter<i class="fa fa-times" aria-hidden="true"></i></h1>
	<div class="filter-list" id="sticky-list">
    	...
    	<ul>
          ...
          */ ?>
          <li class="has-sub filter-color">
              <a href="">Warna<div class="display"></div></a>
              <ul id="ul-color">
    ...
    <ul>
        ...
        <li>            
            <select id="sort">
                ...
                ?>
                <option value="recommended=asc" <?php echo (isset($_GET["recommended"]) && $_GET["recommended"] == "asc") ? "selected" : ""; ?>>Rekomendasi</option>
...
@section('marketing-tag-body')
    <?php /*
    @if(getMarketingEnv() == true)
        @include('marketing-tag.berrybenka.mobile.promo-body')
    @endif
    /*/?>
@endsection