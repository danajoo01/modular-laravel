                    ...
                    <div class="filter-wrapper">
                        ...
                        <div class="filter-item gender">
                            ...
                            <ul>
                                ...
                                <li>
                                    <input type="radio" 
                                    id="checkbox-gender-wanita"
                                    data-gender="women" 
                                    onclick="ChangeUrl(this)" 
                                    name="gender"
                                    @if(isset($gender) && $gender == 'women') 
                                        checked="checked" 
                                    @endif
                                    >
                ...
                <ul id="ul-catalog">
                    ...
                    @foreach ($catalog as $row)
                        ...
                        <li id="li-catalog">
                            ...
                            <a href="{{ $url }}" onClick="onProductClick({{ $row->pid }}, '{{ $row->product_name }}', '{{ $row->url_set }}', '{{ $row->brand_name }}', '', {{ $index }}, 'Special Page', '{{ $url }}')">
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.berrybenka.desktop.promo-page', ['catalog_ids' => $catalog_json])
@endif
...
@section('marketing-tag-body')
    <?php /*
    @if(getMarketingEnv() == true)
        @include('marketing-tag.berrybenka.desktop.promo-body')
    @endif
    */ ?>
@endsection