...
@section('meta')
    ...
    <meta property="og:site_name" content="berrybenka.com" />   
...
@section('css')
<link rel="stylesheet" href="{{ asset('berrybenka/desktop/css/detail.css') }}">
...
<link rel="stylesheet" href="{{ asset('berrybenka/desktop/script/featherlight.css') }}">
<script type="text/javascript" src="{{ asset('berrybenka/desktop/script/featherlight.js') }}"></script>
@endsection
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.berrybenka.desktop.product-page', ['catalog_ids' => json_encode($catalog_json), 'mkt_product_id' =>json_encode(isset($fetch_product->pid) ? $fetch_product->pid : '')])
@endif
