                    ...
                    @if (count($gender) > 1)
                      <div class="filter-gender filter-content">
                        ...
                        <ul>
                          ...
                          ?>
                            <li>
                                <input type="radio" id="checkbox-gender-{{ $gender_name }}" data-gender="gender={{ $gender_name }}" onclick="ChangeUrl(this)" @if(isset($get['gender']) && $get['gender'] == $gender_name) checked="checked" @endif  name="gender">
                    ...
                    ?>
					 <li id="li-catalog">
                        <a href="{{ $url }}" class="catalog-img">                
                            ...
                            @if(isset($row->set_display_oos_set_sd) && $row->set_display_oos_set_sd == 1  && ($row->product_status == 2 || (int) $row->inventory == 0))
                                <?php
...
@section('marketing-tag-body')
    @if(getMarketingEnv() == true)
        @include('marketing-tag.shopdeca.desktop.brand')
    @endif
@endsection