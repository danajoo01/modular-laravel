		...
		<div class="wrapper">
            ...
            <div class="detail-wrapper">
            	<div class="detail-photo left">
                	<div class="big-photo left"><a class="fancybox-effects-c" href="{{ asset('berrybenka/theme/img/detail-big.jpg') }}"><img src="{{ asset('berrybenka/theme/img/detail-big.jpg') }}"></a></div>
                    <div class="small-photo left">
                    	<ul>
                        	<li><a class="fancybox-effects-c" href="{{ asset('berrybenka/theme/img/detail-small.jpg') }}"><img src="{{ asset('berrybenka/theme/img/detail-small.jpg') }}"></a></li>
                            <li><a class="fancybox-effects-c" href="{{ asset('berrybenka/theme/img/detail-small.jpg') }}"><img src="{{ asset('berrybenka/theme/img/detail-small.jpg') }}"></a></li>
                            <li><a class="fancybox-effects-c" href="{{ asset('berrybenka/theme/img/detail-small.jpg') }}"><img src="{{ asset('berrybenka/theme/img/detail-small.jpg') }}"></a></li>
                            <li><a class="fancybox-effects-c" href="{{ asset('berrybenka/theme/img/bb-detail-small.jpg') }}"><img src="{{ asset('berrybenka/theme/img/bb-detail-small.jpg') }}"></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <ul>
                    ...
                    <li>
                        <a href="#"><img src="http://im.berrybenka.biz/{{ asset('berrybenka/theme/cache/238x358/product/zoom/74433_kyle-v-top_white_LGIT6.jpg') }}"></a>
                        <div class="catalog-detail">
                            <a href="#">
                                <h1 class="catalog-name">Lorine</h1>
                                <h2 class="catalog-brand">Waiscoat Denim Bella</h2>
