	...
	<div class="filter-list" id="sticky-list">
    	...
    	<ul>
          <li class="has-sub filter-gender">
            ...
            <ul>
            	<li>
                <input type="radio" name="gender" value="Pria|men" id="RadioGroup-men" >
                <label for="RadioGroup-men">Pria</label>
              </li>
              <li>
                <input type="radio" name="gender" value="Wanita|women" id="RadioGroup-women" >
                <label for="RadioGroup-women">Wanita</label>
              </li>
              <li>
                <input type="radio" name="gender" value="Semua|all" id="RadioGroup-all" >
        	...
        	<li>
            	<a href="{{ $url }}">
                    <div class="catalog-img">
                        <input type="hidden" id="pagenum" value="@if($page_num > 0){{ $page_num }}@endif"> 
                        <?php
                        ...
                        @if(isset($row->set_display_oos_set_hb) && $row->set_display_oos_set_hb == 1  && ($row->product_status == 2 || (int) $inventory == 0))
...
<script src="{{ asset('js/mobile/product-mobile.js?t=').date('YmdHis') }}"></script>
@endsection
