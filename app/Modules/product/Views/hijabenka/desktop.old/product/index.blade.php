...
<!--                        <a href="javascript:void();"> 
                            <div class="add2wish" id="add2wish-{{ $row->pid }}" rel="{{ $row->pid }}" onclick="set_wishlist(this)" {{ $style }}>
                                <i class="fa fa-heart {{ $set_active_wishlist }}" id="wish_{{ $row->pid }}">
                                    <div class="b-tips">
                                        Add to Wishlist
                                    </div>
                                </i>
                            </div>
                            <div class="wishlist-loading" id="wish-loading-{{ $row->pid }}">
                                <div class="load-icon">
                                    <img src="{{ asset('hijabenka/desktop/img/bb-loading.gif') }}">
                                </div>
                            </div>
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.hijabenka.desktop.category-page', ['catalog_ids' => $catalog_json])
@endif
