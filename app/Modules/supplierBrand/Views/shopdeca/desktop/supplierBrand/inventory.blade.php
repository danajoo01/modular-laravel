@extends('supplier.shopdeca.desktop.main')

@section('css')
<!-- CSS here -->
<link rel="stylesheet" href="{{ asset('shopdeca/desktop/css/order-stat-track.css') }}">
<link rel="stylesheet" href="{{ asset('shopdeca/desktop/css/about.css') }}">
<link rel="stylesheet" href="{{ asset('shopdeca/desktop/css/supplier.css') }}">
@endsection
