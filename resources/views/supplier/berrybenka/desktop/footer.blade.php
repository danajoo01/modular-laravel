<footer>
    	...
    	<div class="wrapper">
            ...
            <div class="subscriber right">
                ...
                <div class="subscribe">
                    ...
                    <input type="submit" id="subscribe_men" value="Pria">
                    <input type="submit" id="subscribe_women" value="wanita">
                    </form>
                </div>
                <p>Belanja Lewat Mobile App</p>
                <div class="appstore">
                	<ul>
                    	<li><a href="https://itunes.apple.com/us/app/berrybenka/id961924940" target="_blank"><img src="{{ asset('berrybenka/desktop/img/apple.gif') }}"></a></li>
                        <li><a href="https://play.google.com/store/apps/details?id=com.berrybenka.android" target="_blank"><img src="{{ asset('berrybenka/desktop/img/google.gif') }}"></a></li>
                    </ul>
                </div>
            </div>
            <div class="clear"></div>
    ...
    <div class="bottom-footer">
    	<div class="wrapper">
        	<div class="follow">
                <ul>
                    <li><a href="https://www.facebook.com/BerrybenkaShop/" target="_blank"><i class="fa fa-facebook-official"></i></a></li>
                    <li><a href="https://twitter.com/Berrybenka" target="_blank"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="https://www.instagram.com/berrybenka/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                    <li><a href="https://www.youtube.com/user/BERRYBENKADOTCOM" target="_blank"><i class="fa fa-youtube-play"></i></a></li>
                </ul>
            </div>
        	<div class="copyright"> ALL RIGHTS RESERVED &copy; 2018 BERRYBENKA.COM </div>
            <div class="payment-certificate">
            	<span><a href="#"><i class="fa fa-cc-mastercard"></i></a></span>
            	<span><a href="http://visa.co.id/ap/id/personal/security/onlineshopping.shtml" target="_blank"><i class="fa fa-cc-visa"></i></a></span>
            </div>
            <div class="clear"></div>
        </div>
    </div>
