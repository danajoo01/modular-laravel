...
<head>
    ...
    <meta name="apple-mobile-web-app-title"  content="hijabenka">
    ...
    <link rel="stylesheet" href="{{ asset('hijabenka/mobile/css/core.css') }}">
    <link rel="stylesheet" href="{{ asset('hijabenka/mobile/css/login.css') }}">
    <link rel="stylesheet" href="{{ asset('hijabenka/mobile/css/font-awesome.min.css') }}">
...
<script src="{{ asset('hijabenka/mobile/script/flexslider/jquery.flexslider.js') }}"></script>
<script src="{{ asset('hijabenka/mobile/script/core.js') }}"></script>
