    ...
    <div class="header-mid">
        <a class="logo" href="{{ URL::to('/') }}">
            @if($date_logo < "2018-01-01")
                <img class="black-logo" src="{{ asset('hijabenka/desktop/img/hb-logo.png') }}">
                <img class="white-logo" src="{{ asset('hijabenka/desktop/img/hb-logo-white.png') }}">
...
<div class="login-wrapper">
    <div class="login-outer">
        ...
        @if(get_uri() !== FALSE)
            <a href="/login?continue={{ urlencode(get_uri()) }}" class="register-link">belum punya akun hijabenka?? <span>buat baru.</span></a>
        @else
            <a href="/login" class="register-link">belum punya akun hijabenka?? <span>buat baru.</span></a>
        @endif 
        </form>
    </div>
</div>
