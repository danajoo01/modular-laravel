...
<head>
    ...
    <meta name="author" content="store2go.com">
<!--    <meta name="google-site-verification" content="Ea_eO8eyxg_9GhRxWqQaGoNBHg0rZFRT84ovScDXR48" />-->
    ...
    <link rel="stylesheet" href="{{ asset('berrybenka/desktop/css/core.css?t=').date('YmdHis') }}"><!-- ?t=').date('YmdHis') -->
    <link rel="stylesheet" href="{{ asset('berrybenka/desktop/css/search.css?t=').date('YmdHis') }}">    
    ...
    <link rel="stylesheet" href="{{ asset('berrybenka/desktop/script/scrollable/jquery.scrollable.css') }}">
    <link rel="stylesheet" href="{{ asset('berrybenka/desktop/flexslider/flexslider.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('berrybenka/desktop/script/fancybox/jquery.fancybox.css') }}" media="screen" />
    <link rel="stylesheet" type="text/css" href="{{ asset('berrybenka/desktop/css/jquery.fancybox.css') }}" media="screen" />
    ...
    <?php /*<link rel="shortcut icon" type="image/x-icon" href="{{ asset('berrybenka/desktop/img/favicon.png') }}" /> */?>
...
<body>
    ...
    @include('layouts.berrybenka.desktop.header')

    @yield('content')
        
    <!-- /#page-wrapper   -->
    @include('layouts.berrybenka.desktop.footer')    
...
<script type="text/javascript" src="{{ asset('berrybenka/desktop/script/jslog.js') }}"></script>
<?php endif; ?>
<!-- BB JS -->
<script type="text/javascript" src="{{ asset('berrybenka/desktop/script/sticky-side.js') }}"></script>
<script type="text/javascript" src="{{ asset('berrybenka/desktop/script/sticky.js') }}"></script>
<script src="{{ asset('js/jquery-ui.js') }}"></script>
<script src="{{ asset('berrybenka/desktop/script/autocomplete.js?t=').date('YmdHis') }}"></script>
<script src="{{ asset('berrybenka/desktop/script/scrollable/jquery.scrollable.js') }}"></script>
<script src="{{ asset('berrybenka/desktop/script/fancybox/jquery.fancybox.pack.js') }}"></script>
<script src="{{ asset('berrybenka/desktop/script/clipboard/clipboard.min.js') }}"></script>
<script src="{{ asset('berrybenka/desktop/script/core.js?t=').date('YmdHis') }}"></script>
<script src="{{ asset('berrybenka/desktop/script/lazyload.js') }}"></script>
<script src="{{ asset('js/desktop/app_bb.js?t=').date('YmdHis') }}"></script>
<!-- <script src="{{ asset('berrybenka/desktop/script/global.js') }}"></script> -->

<script type="text/javascript" src="{{ asset('berrybenka/desktop/flexslider/jquery.flexslider.js') }}"></script>
...
@if(getMarketingEnv() == true)
    ...
    @include('marketing-tag.berrybenka.desktop.all-pages')
...
@if(getMarketingEnv() == true)
    @include('marketing-tag.berrybenka.desktop.gtm')
@endif
</html>
