			    ...
			    <div class="five columns">
			        <div class="sidebarCont">
			            ...
			            <ul class="sidebar-list">
                                        ...
                                        <li class="help-active"><a href="{{ url('/') }}/home/help_return_watch"><i class="fa fa-compass"></i>Ketentuan Pengembalian Produk Jam Tangan</a></li>
			            ...
			            <div class="list-q">
			            	<ul>
			                	<li>
			                        ...
			                        <div>Batas waktu pengembalian tidak lebih dari 14 hari sejak produk jam tangan diterima pembeli. Berrybenka akan membantu menangani klaim garansi dalam rentang waktu 14 hari sejak diterimanya produk. Apabila melebihi dari 14 hari maka klaim garansi akan diarahkan langsung ke distributor resmi.
			                        </div>
			                    </li>
			                    <li>
			                        ...
			                        <div>
			                        	<ol style="list-style-type: disc;">
			                                ...
			                                <li>Berrybenka berhak menolak pengembalian produk jika ada persyaratan yang tidak dipenuhi</li>
			                            </ol>
			                        </div>
			                    </li>
			                    <li>
			                    ...
			                    <li>
			                        ...
			                        <div>
			                            ...
			                            <li>Setelah produk diterima, Berrybenka akan melakukan pengecekan kualitas kembali dalam waktu 2 x 24 jam</li>
			                    ...
			                    <li>
			                        ...
			                        <div>Waktu yang dibutuhkan untuk memperbaiki produk jam tangan bergantung kepada tingkat kerusakan dan ketersediaan suku cadang. Berrybenka akan menginformasikan durasi perbaikan produk jam tangan.</div>
			                    </li>
			                    <li>
			                    ...
			                    <li>
			                        ...
			                        <div>
			Pada umumnya, pengembalian produk tersebut memakan waktu 7 hari untuk Jakarta dan 15 hari untuk luar Jakarta terhitung dari saat pembeli menerima barangnya dan syarat dan ketentuan pengembaliannya telah disetujui oleh Berrybenka.
			                        </div>
			                    </li>
			                    <li>
			                    ...
			                    <li>
			                    	<a>KETENTUAN PENGIRIMAN PRODUK JAM TANGAN KE DISTRIBUTOR VIA BERRYBENKA</a>
			                        <div>Apabila pelanggan berdomisili di lokasi yang tidak ada kantor cabang distributor resmi, maka pelanggan dapat mengirimkan produk ke Berrybenka yang selanjutnya akan meneruskan kepada pusat pelayanan distributor terdekat</div>
			                    </li>
			                    <li>
			                    	<a>BIAYA PERBAIKAN</a>
