			    ...
			    <div class="five columns">
			        <div class="sidebarCont">
			            ...
			            <ul class="sidebar-list">
                                        ...
                                        <?php /*
                                        <li class="help-active"><a href="{{ url('/') }}/home/same-day"><i class="fa fa-question-circle"></i>Same Day &amp; Next Day Delivery</a></li>*/?>
                                    </ul>       
			        </div>
			    </div>
