            	...
            	<div class="row">
				    <div class="five columns">
				        <div class="sidebarCont">
				            ...
				            <ul class="sidebar-list">
				                <li class="help-active"><a href="{{ url('/') }}/home/cod"><i class="fa fa-question-circle"></i>Bayar di tempat</a></li>
				    ...
				    <div class="eleven columns">
				      ...
				      <div class="full-width mb20">
				        <div class="static-content">
				          ...
				          <ol>
				            ...
				            <li>Pengiriman menggunakan vendor pengiriman yaitu aCommerce dan RPX</li>
				            <li>Maksimal pembelian Rp 1.000.000,- (satu juta rupiah)</li>
                                            <li>Apabila ingin melakukan pengembalian barang, mohon melihat syarat dan ketentuan (<i>cek <a href="/home/help_return" style="text-decoration: underline;">Ketentuan Pengembalian</a></i>) dan pelanggan dipastikan telah melakukan pembayaran terlebih dahulu ditempat</li>
				      ...
				      <div class="full-width mb20">
				        <div class="static-content">
				          <p> INFORMASI </p>
				          <p> Hijabenka menggunakan jasa Ninjavan & Etobee untuk wilayah JABODETABEK, dan untuk wilayah di luar JABODETABEK menggunakan JX dan J&amp;T . </p>
				        </div>
				      </div>
				    </div>
				  </div>
