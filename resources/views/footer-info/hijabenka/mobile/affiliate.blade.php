...
<div class="affiliate-container  mb30">
    <div class="row" style="margin: 0 !important;">
            ...
            <p>HIJABENKA affiliate program adalah program partnership yang menguntungkan untuk para pemilik situs melalui link afiliasi . Tampilkan link/banner HIJABENKA.com pada website atau blog Anda dan bersiaplah mendapatkan komisi dari setiap transaksi yang Anda referensikan.</p>
        ...
        <div class="affiliate-content">
            <h1>HOW IT WORKS</h1>
            <ul>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/list1.gif"><p>Daftar menjadi partner affiliate HIJABENKA</p></li>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/list2.gif"><p>Partner menampilkan banner/link hijabenka.com</p></li>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/list3.gif"><p>Pengunjung website/blog partner meng-klik banner/link hijabenka.com</p></li>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/list4.gif"><p>Partner mendapat komisi  (IDR) dari transaksi pengunjung</p></li>
            </ul>
        </div>
        <div class="half-page-wrapper">
            <div class="half-page clearit">
                <div class="half-page-left">
                    <img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/commission-icon.gif">
                    <h1>COMMISSION</h1>
                    <p>Kami memberikan komisi setiap bulannya, dengan besar komisi 10% untuk setiap transaksi yang direferensikan dari link afiliasi HIJABENKA.com yang ada pada website atau blog Anda.</p><br>
                    <img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/report.gif">
                    <h1>REPORT</h1>
                    ...
                    <img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/support.gif">
                    <h1>SUPPORT</h1>
                    <p>Anda dapat menghubungi kami  untuk pertanyaan, kritik, saran, dan berbagai informasi  tentang HIJABENKA.com affiliate program, melalui form disamping ini. </p><br>
					<img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/networking-group.png">
					<h1>REFERRAL</h1>
                    <p>Mau dapat komisi lebih banyak dari affiliate Hijabenka?</p>
                    <p>Ajak orang-orang terdekat Anda untuk mendaftar jadi partner affiliate Hijabenka, dan dapatkan tambahan komisi 10%. Tahu lebih banyak, <a href="http://m.hijabenka.com/affiliate/referral"><strong><u>klik disini</u></strong></a></p>
				</div>
        ...
        <div class="affiliate-content affiliate-content2" style="margin:0;">
            ...
            <ul>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/free.gif"><p>GRATIS<br>dan siapapun bisa bergabung</p></li>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/sale.gif"><p>HIJABENKA <br>menjual lebih dari 1000 brand lokal dan internasional</p></li>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/list44.gif"><p>Komisi <br><strong>10%</strong><br> Untuk setiap transaksi</p></li>
		<li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/networking-group.png"><p style="font-size:14px;">Tambahan komisi dengan<br><strong style="font-size:16px;">Affiliate Referral</strong></p></li>
                <li><img src="http://m.hijabenka.com/hijabenka/desktop/img/affiliate/timsupport.gif"><p><strong style="font-size:14px;line-height:1.2;">Realtime Report &amp; Tim Support</strong><br> yang siap membantu</p></li>
			</ul>
        </div>
        <a href="https://berrybenka.hasoffers.com/signup" class="sign-log">daftar sekarang</a>
        <p class="reg-text">Atau belum menjadi member HIJABENKA.com, registrasi <a href="https://hijabenka.com/customer/account/auth"><strong>disini</strong></a> dan dapatkan voucher belanja</p>
        <div class="keterangan">
            <ul>
                <li><a href="https://blogaffiliateberrybenka.wordpress.com/">Blog</a></li>
                <li>|</li>
                <li><a href="http://m.hijabenka.com/affiliate/faq">FAQ</a></li>
                <li>|</li>
                <li><a href="http://m.hijabenka.com/affiliate/illustration">Ilustrasi Kerja</a></li>
            </ul>
        </div>
    </div>
</div>
