				    ...
				    <div class="eleven columns">
				      ...
				      <div class="full-width mb20">
				        <div class="static-content">
				          <p>Apakah Hijabenka.com memiliki toko retail?</p>
				          <p>Iya, Saat ini Hijabenka.com memiliki pop up store di beberapa wilayah jabodetabek dan non jabodetabek, Kamu bisa dapatkan informasi mengenai pop up store kami melalui cs@berrybenka.com</p>
				          	
				            <div class="list-q">
				            	<ul>
				                	<li>
				                    	<a>Apakah saya harus membuat akun untuk berbelanja di Hijabenka.com?</a>
				                    ...
				                    <li>
				                    	<a>Bagaimana Saya bisa mendapatkan akun Hijabenka.com?</a>
				                        <div>
                                                        Anda dapat melakukan registrasi dengan mengklik tautan "Log in / Sign up" pada bagian pojok kanan atas halaman website. Lalu isi identitas lengkap Anda pada bagian "NOT REGISTER YET". 
                                                        Mohon pastikan bahwa identitas yang Anda isi adalah benar, kemudian tekan tombol "Create an Account". Setelahnya, Anda memiliki akun Hijabenka! Mohon untuk mengisi alamat lengkap Anda pada menu “Account - Edit Address Detail”.</div>
				                    </li>
				                    <li>
				                    	<a>Bagaimana cara mengubah data pribadi saya di Hijabenka.com?</a>
				                    ...
				                    <li>
				                        ...
				                        <div>Barang hanya akan dikirim setelah kami menerima pembayaran Anda. Saat Anda telah menyelesaikan proses pembayaran, Hijabenka menyarankan agar Anda melakukan konfirmasi dengan meng-klik pilihan "Confirm" pada halaman. "My Account". Saat proses konfirmasi selesai, Hijabenka akan segera memproses pesanan Anda dan mengirimkannya ke alamat yang telah dicantumkan.</div>
				                    </li>
				                    <li>
				                    ...
				                    <li>
				                    	<a>Bagaimana saya bisa menggunakan Promo / Gift Voucher Hijabenka?</a>
				                    ...
				                    <li>
				                        ...
				                        <div>Benka Poin adalah sejumlah nominal yang tersimpan dalam akun Hijabenka Anda. Anda bisa menggunakan Benka Poin untuk melakukan pembelian pada Hijabenka.com</div>
				                    </li>
				                    <li>
				                    	<a>Bagaimana saya dapat menggunakan Benka Poin?</a>
				                        <div>Benka Poin dapat digunakan secara langsung saat Anda ingin berbelanja di Hijabenka.com. Jumlah Benka Poin akan mengurangi total pembayaran Anda. Benka Poin tidak dapat digabungkan dengan Promo atau Voucher tertentu.</div>
				                    </li>
				                    <li>
				                    ...
				                    <li>
				                    	<a>Apakah proses pembayaran di Hijabenka.com aman?</a>
				                        <div>Proses pembayaran kami aman dan kami berkomitmen untuk selalu menjaga data pribadi Anda. Data Anda aman dan tidak akan digunakan untuk tujuan penggunaan lainnya selain Hijabenka.com.</div>
				                    </li>
				                    <li>
				                    	<a>Apakah saya bisa mengganti atau membatalkan pesanan saya?</a>
				                        <div>Jika Anda belum melakukan pembayaran ke rekening kami (via transfer bank ke rekening Hijabenka atau Cash-On-Delivery), Anda masih bisa membatalkan pesanan dengan menginformasikan ke pelayanan pelanggan. Namun, setelah Anda melakukan pembayaran, pesanan Anda tidak dapat dibatalkan atau diganti.</div>
				                    </li>
				                    <li>
