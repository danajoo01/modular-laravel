...
Pengiriman akan kembali normal per tanggal 3 Juli 2017. Sementara itu, semua offline stores kami akan beroperasional seperti biasa selama libur Idul Fitri. Kami mohon maaf atas ketidaknyamanan tersebut, apabila ada pertanyaan lebih lanjut dapat dikirimkan via email ke cs@berrybenka.com.
              ...
              </div> <br> Waktu pengiriman ini berlaku setelah pembayaran kami terima, kecuali untuk pemesanan yang menggunakan COD. Untuk barang yang berupa aerosol/minyak/air diluar jakarta akan memakan waktu 14 hari kerja untuk sampai ke tujuan. <br><br> Kami tidak melakukan pengiriman pada hari libur nasional.					</div>
			                    </li>
			                    <li>
			                    	<a>BIAYA PENGIRIMAN</a>
                                                <div class="city-choose">
                                                  ...
                                                  <span id="shipping_fee" style="border:none;width:150px;"></span>
                                                    ...
                                                    <br />
			                            <P> Setiap transaksi di Hijabenka bebas ongkos kirim dengan minimum pembelian Rp. 300.000 </P>
			                        </div>
			                    </li>
			                    <li>
