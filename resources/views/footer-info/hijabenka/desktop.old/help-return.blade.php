			            ...
			            <div class="list-q">
			                	...
			                	<li>
			                        ...
			                        <div>
			                        	<ul>
			                                ...
			                                <li>Harap tidak mengisolasi kotak secara berlebihan tetapi cukup membungkusnya untuk mencegah kerusakan. Barang tersebut tetap menjadi tanggung jawab Anda sampai Hijabenka menerimanya.</li>
                          ...
                          <?php /*
			                    <li>
			                        ...
			                        <div>
                                                    <ol>
                                                        <li>Anda diwajibkan menyertakan bukti resi pengiriman barang saat mengembalikan barang ke Warehouse Hijabenka dan mengirimkan foto bukti resi ke <a href="mailto:cs@berrybenka.com" style="display:inline;">cs@berrybenka.com</a> sebelum barang retur diterima di Warehouse Hijabenka.</li>
                                                        <li>Biaya pengembalian barang akan diproses dalam waktu 2 x 24 jam sejak barang retur diproses di Warehouse Hijabenka.</li>
                                                        <li>Biaya pengiriman di bawah Rp 10.000 akan dikreditkan ke akun Hijabenka Anda sedangkan untuk biaya pengiriman di atas Rp 10.000 akan di refund ke rekening Anda (apabila Anda mencantumkan nomor rekening Anda).</li>
                                                        <li>Untuk penggantian biaya pengembalian barang akan disesuaikan dengan standar tarif reguler dari JNE. Hijabenka akan melakukan penggantian biaya maksimal senilai Rp.30.000,-.</li>
                                                        <li>Hijabenka tidak akan mengganti biaya pengembalian barang yang dikirim ke warehouse Berrybenka dengan metode COD (Cash on Delivery).</li>
                                                    </ol>
			                            <div class="city-choose" id="create-shipping">
...
<!--                                            <li>
			                        ...
			                        <div>
                                                    ...
                                                    Sertakan formulir pengembalian pada saat melakukan pengiriman barang. Apabila tidak, Hijabenka berhak untuk menolak proses pengembalian lebih lanjut (Form pengembalian dapat ditemukan di dalam kotak kemasan paket pengiriman Anda).
			                        </div>
			                    </li>-->
<!--                                            <li>
			                        ...
			                        <div>
                                                  ...
                                                  <li>Masuk ke menu akun Anda di <a href="http://www.hijabenka.com">www.Hijabenka.com</a></li>
                                                  ...
                                                  <li>Tunggu notifikasi melalui email atau informasi dari tim Customer Service Hijabenka</li>
                                                  </ol>
                                                </div>
			                    </li>-->
<!--                                            <li>
			                        ...
			                        <div>
                                                    Benka Poin hanya akan diberikan apabila barang yang dikembalikan masih dalam kondisi belum terpakai dan tidak rusak dengan tags masih terpasang.. Benka Poin yang diberikan dapat digunakan untuk pembelian berikutnya di Hijabenka. Benka Poin tidak dapat diuangkan.
			                        </div>
			                    </li>-->
			                </ul>
