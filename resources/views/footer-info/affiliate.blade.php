            ...
            <div class="about-wrapper affi-wrapper">
            	<div class="sixteen columns affiliate-header">
                    <a class="affi-head-img" target="_blank" href="https://berrybenka.hasoffers.com/login">
                        <img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/banner.jpg">
                    </a>
                ...
                <div class="affiliate-content">
                    <h1>HOW IT WORKS</h1>
                    <ul>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/list1.gif"><p>Daftar menjadi partner affiliate BERRYBENKA</p></li>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/list2.gif"><p>Partner menampilkan banner/link berrybenka.com</p></li>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/list3.gif"><p>Pengunjung website/blog partner meng-klik banner/link berrybenka.com</p></li>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/list4.gif"><p>Partner mendapat komisi  (IDR) dari transaksi pengunjung</p></li>
                    </ul>
                </div>
                <div class="half-page-wrapper">
                    <div class="half-page clearit">
                        <div class="half-page-left">
                            <div class="hp-item">
                            	<img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/commission-icon.gif">
                                <h1>COMMISSION</h1>
                            ...
                            <div class="hp-item">
                            	<img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/report.gif">
                                <h1>REPORT</h1>
                            ...
                            <div class="hp-item">
                            	<img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/support.gif">
                                <h1>SUPPORT</h1>
                            ...
                            <div class="hp-item">
                            	<img style="margin:0 20px 50px 20px;" src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/networking-group.png">
                                <h1>REFERRAL</h1>
                ...
                <div style="margin:0;" class="affiliate-content affiliate-content2">
                    ...
                    <ul>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/free.gif"><p>GRATIS<br>dan siapapun bisa bergabung</p></li>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/sale.gif"><p>BERRYBENKA <br>menjual lebih dari 1000 brand lokal dan internasional</p></li>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/list44.gif"><p>Komisi <br><strong>10%</strong><br> Untuk setiap transaksi</p></li>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/networking-group.png"><p style="font-size:14px;">Tambahan komisi dengan<br><strong style="font-size:16px;">Affiliate Referral</strong></p></li>
                        <li><img src="http://berrybenka.com/assets/berrybenka/desktop/img/affiliate/timsupport.gif"><p><strong style="font-size:14px;line-height:1.2;">Realtime Report &amp; Tim Support</strong><br> yang siap membantu</p></li>
                    </ul>
                </div>
