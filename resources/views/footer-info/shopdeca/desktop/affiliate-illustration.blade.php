        ...
        <div class="error-inside ref-wrap">
            <div class="about-wrapper affi-wrapper">
                ...
                <div class="affiliate-faq">
                    ...
                    <div class="ilustrasi clearit">
                        <ul>
                            <li>
                                <img src="/shopdeca/desktop/img/affiliate/1.jpg">
                                <p>A adalah pemilik website yang ingin mendapatkan income dari websitenya</p>
                            </li>
                            <li>
                                <img src="/shopdeca/desktop/img/affiliate/2.jpg">
                                <p>Tertarik dengan cara yang mudah dan besar komisi 10% yang diberikan, A mendaftar sebagai partner program affiliate </p>
                            </li>
                            <li>
                                <img src="/shopdeca/desktop/img/affiliate/3.jpg">
                                <p>A menampilkan link  dan banner affiliate BERYBENKA pada websitenya </p>
                            </li>
                            <li>
                                <img src="/shopdeca/desktop/img/affiliate/4.jpg">
                                <p>B adalah pengunjung website A. B tertarik dan melakukan klik pada link affiliate yang ditampilkan dalam website A</p>
                            </li>
                            <li>
                                <img src="/shopdeca/desktop/img/affiliate/5.jpg">
                                <p>B diarahkan menuju website SHOPDECA dan melakukan transaksi pembelian</p>
                            </li>
                            <li>
                                <img src="/shopdeca/desktop/img/affiliate/6.jpg">
                                <p>Maka, A sebagai partner affiliate SHOPDECA, berhak mendapatkan komisi 10% atas transaksi yang dilakukan B</p>
                            </li>
                        </ul>
                    </div>
                    <div class="ilustrasi-detail">
            <p>Ilustrasi komisi program affiliate Shopdeca,</p>
            <strong>Shopdeca.com memberikan komisi sebesar 10%  untuk setiap tranksaksi yang berasal dari link affiliate yang direfensikan partner.</strong>
            <div class="simulasi-komisi">
                ...
                <ol>
                    ...
                    <li>
                    	<span>Viewer yang meng-klik dan melakukan<br>transaksi di website shopdeca.com</span>
                        <span> : </span>
                        <span>500 viewer (asumsi 10% )</span>
                    </li>
                    <li>
                    	<span>Average order volume shopdeca.com</span>
                        <span> : </span>
                        <span>Rp 200.000</span>
                    </li>
                </ol>
                <p>Maka asumsi komisi yang akan Anda dapatkan dalam satu bulan adalah,</p>
                <p><strong>500</strong> (Viewer yang meng-klik dan melakukan transakasi di web Shopdeca.com dalam 30 hari setelah meng-klik) <strong>x Rp 200.000</strong> (Average order Shopdeca) <strong>x 10%</strong> (Besar komisi yang diberikan Shopdeca) = <strong>Rp 10.000.000,-/bulan</strong></p>
            </div>
        </div>
                </div>
            </div>
