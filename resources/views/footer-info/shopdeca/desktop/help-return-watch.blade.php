			            ...
			            <div class="list-q">
			            	<ul>
			                	<li>
			                        ...
			                        <div>Batas waktu pengembalian tidak lebih dari 14 hari sejak produk jam tangan diterima pembeli. Shopdeca akan membantu menangani klaim garansi dalam rentang waktu 14 hari sejak diterimanya produk. Apabila melebihi dari 14 hari maka klaim garansi akan diarahkan langsung ke distributor resmi.
			                        </div>
			                    </li>
			                    <li>
			                        ...
			                        <div>
			                        	<ol style="list-style-type: disc;">
			                                ...
			                                <li>Shopdeca berhak menolak pengembalian produk jika ada persyaratan yang tidak dipenuhi</li>
			                            </ol>
			                        </div>
			                    </li>
			                    <li>
			                    ...
			                    <li>
			                        ...
			                        <div>
			                            ...
			                            <li>Setelah produk diterima, Shopdeca akan melakukan pengecekan kualitas kembali dalam waktu 2 x 24 jam</li>
			                    ...
			                    <li>
			                        ...
			                        <div>Waktu yang dibutuhkan untuk memperbaiki produk jam tangan bergantung kepada tingkat kerusakan dan ketersediaan suku cadang. Shopdeca akan menginformasikan durasi perbaikan produk jam tangan.</div>
			                    </li>
			                    <li>
			                    ...
			                    <li>
			                        ...
			                        <div>
			Pada umumnya, pengembalian produk tersebut memakan waktu 7 hari untuk Jakarta dan 15 hari untuk luar Jakarta terhitung dari saat pembeli menerima barangnya dan syarat dan ketentuan pengembaliannya telah disetujui oleh Shopdeca.
			                        </div>
			                    </li>
			                    <li>
			                    ...
			                    <li>
			                    	<a>KETENTUAN PENGIRIMAN PRODUK JAM TANGAN KE DISTRIBUTOR VIA SHOPDECA</a>
			                        <div>Apabila pelanggan berdomisili di lokasi yang tidak ada kantor cabang distributor resmi, maka pelanggan dapat mengirimkan produk ke Shopdeca yang selanjutnya akan meneruskan kepada pusat pelayanan distributor terdekat</div>
			                    </li>
			                    <li>
			                    	<a>BIAYA PERBAIKAN</a>
