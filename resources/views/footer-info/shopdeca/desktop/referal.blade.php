...
<link rel="stylesheet" href="{{ asset('shopdeca/desktop/css/about.css') }}">
@endsection
        ...
        <div class="error-inside ref-wrap">
            <div class="about-wrapper tnc-wrapper">
                ...
                <div class="referral-title">
                    <h1>Undang Teman untuk Belanja Gratis di Shopdeca</h1>
                    <p>Kini Shopdeca hadir dengan fitur baru yaitu Referral Program. Dengan fitur ini, Anda bisa membagikan referral code Anda kepada teman atau keluarga. Jika referral code Anda digunakan oleh teman untuk belanja di Shopdeca, Anda akan langsung mendapatkan Benka Poin senilai IDR 25.000!</p>
                </div>
                <div class="referral-howto">
                    <ul>
                        <li><span>1</span>Undang teman Anda untuk mendownload dan mendaftar Aplikasi Shopdeca.</li>
                        <li><span>2</span>Teman yang Anda undang akan mendapatkan Benka Poin senilai Rp 25.000.</li>
                        <li><span>3</span>Benka Poin dapat digunakan sebagai alat bayar dan diskon di Shopdeca dan Hijabenka.</li>
                ...
                <div class="referral-howto">
                    ...
                    <ul>
                        <li class="img"><span>1</span><img src="http://im.berrybenka.biz/assets/landing_page/rev1jpg_YV3JE.jpg">Buka Aplikasi Shopdeca dari iPhone atau Android dan login dengan email anda</li>
                ...
                <div class="referral-howto">
                    ...
                    <ul>
                        <li class="img"><span>1</span><img src="http://im.berrybenka.biz/assets/landing_page/rev3jpg_5UF0O.jpg">Klik link yang diberikan oleh teman anda, anda akan langsung dibawa ke halaman Shopdeca di Android Play Store atau di iOS App Store</li>
                        <li class="img"><span>2</span><img src="http://im.berrybenka.biz/assets/landing_page/rev5jpg_N07UD.jpg">Install Aplikasi Shopdeca dari Android Play Store ataupun dari iOS App Store tersebut</li>
                        <li class="img"><span>3</span><img src="http://im.berrybenka.biz/assets/landing_page/rev6jpg_TSMZ0.jpg">Buka Aplikasi Shopdeca dan Daftar menjadi pengguna</li>
                ...
                <div class="syaratketentuan">
                    <ul>
                        ...
                        <li>Benka Poin hanya bisa didapatkan apabila anda mengunduh dan mendaftar akun baru di Aplikasi Shopdeca </li>
                        ...
                        <li><strong>Shopdeca berhak menolak dan membatalkan segala bentuk transaksi apabila ditemukan kecurangan yang dilakukan oleh pengguna.</strong></li>
                    </ul>
                </div>
                <!--<a class="ref-invite" href="https://Shopdeca.com/user/referral_program">Undang Teman Sekarang</a>-->
            </div>
        </div>
    </div>
</div>
