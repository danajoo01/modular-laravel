			            ...
			            <div class="list-q">
			            	<ul>
			                    ...
			                    <li>
			                        ...
			                        <p class="sameday-first"><b>Same-day Delivery</b></p>
			                        <p>
			                         Untuk mendapatkan layanan ini, kamu cukup membayar biaya tambahan sebesar Rp 20.000 saja. Tambahan biaya kirim hanya akan muncul di layar ponsel atau desktop-mu jika kamu memilih metode pengiriman Same-day Delivery.                         </p><br>
			                        <p class="sameday-first"><b>Next Day Delivery</b></p>
			                        <p>
			                         Untuk mendapatkan layanan ini, biaya tambahannya hanya sebesar Rp 15.000 saja. Seperti halnya Same-day Delivery, tambahan biaya kirim hanya akan muncul di layar ponsel atau desktop-mu jika kamu memilih metode pengiriman Next Day Delivery.</p>
			                        </div>
			                    </li>
			                    <li>
			                    	<a>CAKUPAN WILAYAH</a>
								...
								Saat ini tim Shopdeca juga sedang membangun layanan yang sama di apps kami untuk memudahkan kamu yang sudah <a style="text-decoration:underline;" href="https://itunes.apple.com/us/app/shopdeca/id961924940" target="_blank">download apps IOS</a> dan <a style="text-decoration:underline;" href="https://play.google.com/store/apps/details?id=com.shopdeca.android" target="_blank">download apps Android</a> Shopdeca. Tunggu kehadirannya segera!
								</p>
			                        </div>
			                    </li>
			                    <li>
			                    	<a>MINIMAL PEMBELANJAAN & CARA PEMBAYARAN</a>
			                        <div>
			                        	Layanan ini tersedia bagi kamu yang berbelanja dan melakukan pembayaran melalui kartu kredit Visa/Master, atau kamu yang berbelanja minimum Rp 100,000 melalui BCA KlikPay. Untuk kamu yang kartu kreditnya tidak lolos verifikasi mohon dapat mengirimkan fotocopy KTP dan fotocopy kartu kredit kamu sebagai data validasi kami ke cs@berrybenka.com atau dapat menghubungi customer service kami di 021-2520555 sebelum pukul 11.00 WIB.
