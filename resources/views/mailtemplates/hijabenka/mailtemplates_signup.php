...
<head>
    ...
    <meta http-equiv='Content-Type' content='text/css; charset=UTF-8'/>
        <title>Hijabenka Email Notification</title>
        <style media='all'>
                	...
                	<td align='center' valign='top'>
                                                ...
                                                <table border='0' cellpadding='10' cellspacing='0' width='100%' style='color:#505050'>
                                                    <tr>
                                                        <td valign='middle' style='background-color:#50a7be;'>
                                                            <div mc:edit='std_social' style='text-align:center;'>
                                                             &nbsp;<a style='color:#fff;' href='http://www.twitter.com/Hijabenka'><img src='http://gallery.mailchimp.com/653153ae841fd11de66ad181a/images/sfs_icon_twitter.png' style='margin:0 !important;' /> Follow Twitter HIJABENKA</a> |		
                                                    ...
                                                    <tr>
                                                        <td valign='top'>
                                                            ...
                                                            <b>HIJABENKA CUSTOMER SERVICE</b><br/>
                                                            <table style='font-family:helvetica,arial;font-size:12px'>
                                                                ...
                                                                */?>
                                                                <tr>
                                                                    <td>Email</td>
                                                                    <td>:</td>
                                                                    <td>cs [at] hijabenka [dot] com</a></td>
                                                                </tr>
                                                            </table>
                                                            <br/>
                                                            <img src='<?php echo asset('hijabenka/desktop/img/hb-logo.gif') ?>' style="width: 200px;"/><br/>                                                            
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <table border='0' cellpadding='10' cellspacing='0' width='700' id='templatePreheader'>
                            <tr>
                                ...
                                PT. BERRYBENKA. Jl. KH. Mas Mansyur no. 19 RT 09 / RW 06, Tanah Abang, Jakarta Pusat 10250, Indonesia
                                </div>
                                </td>
                            </tr>
                        </table>
