...
$(document).on("click touchstart", ".bank-promo", function () {
...
/*
 ...
 $(this).parentsUntil('.wish-list ul').hide();
 });*/
...
$(document).ready(function () {
    ...
    $(document).on("click touchstart", ".tab-menu a", function (event) {
...
$(document).ready(function ($) {
    ...
    $(document).on("click touchstart", ".panel h3", function () {
...
$(document).ready(function ($) {
    ...
    $(document).on("click touchstart", ".list-q a", function () {
        //Expand or collapse this panel
        $(this).next().slideToggle('fast');
