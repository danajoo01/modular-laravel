            ...
            $('#cart-container').append('\
              <li class="'+inv_status+'">\
                <ul>\
                  ...
                  <li>IDR ' + number_format(value.price) + '</li>\
                  <li>\
                    <div class="cart-qty">\
                  ...
                  <li id="subtotal-value-' + value.SKU + '">IDR ' + number_format(value.subtotal) + '</li>\
                  <li><a class="remove-cart" href="#" sku="' + value.SKU + '"><i class="fa fa-trash-o"></i></a></li>\
                </ul> \
              </li>\
            ');
